...
class Requester(BaseTolokaObject):
    ...
    class Company(BaseTolokaObject):
        def __init__(self, *, id: Optional[str] = None, superintendent_id: Optional[str] = None) -> None:
    ...
    def __init__(self, *, id: Optional[str] = None, balance: Optional[Decimal] = None, public_name: Optional[Dict[str, str]] = None, company: Optional[Company] = None) -> None:
