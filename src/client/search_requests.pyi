...
class BaseSortItem(BaseTolokaObject):
    ...
    @classmethod
    def structure(cls: Type[TypeVar('SortItemSelf', bound='BaseSortItem')], value: Union[TypeVar('SortItemSelf', bound='BaseSortItem'), str]) -> TypeVar('SortItemSelf', bound='BaseSortItem'): ...
