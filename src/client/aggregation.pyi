...
class PoolAggregatedSolutionRequest(BaseTolokaObject):
    ...
    def __init__(self, *, type: Optional[AggregatedSolutionType] = None, pool_id: Optional[str] = None, answer_weight_skill_id: Optional[str] = None, fields: Optional[List[Field]] = None) -> None:
...
class TaskAggregatedSolutionRequest(BaseTolokaObject):
    ...
    def __init__(self, *, task_id: Optional[str] = None, pool_id: Optional[str] = None) -> None:
...
class WeightedDynamicOverlapTaskAggregatedSolutionRequest(TaskAggregatedSolutionRequest):
    ...
    def __init__(self, *, task_id: Optional[str] = None, pool_id: Optional[str] = None, answer_weight_skill_id: Optional[str] = None, fields: Optional[List[Field]] = None) -> None:
...
class AggregatedSolution(BaseTolokaObject):
    ...
    def __init__(self, *, pool_id: Optional[str] = None, task_id: Optional[str] = None, confidence: Optional[float] = None, output_values: Optional[Dict[str, Any]] = None) -> None:
