...
class TolokaClient:
    ...
    def aggregate_solutions_by_pool(
        self,
        *,
        type: typing.Optional[toloka.client.aggregation.AggregatedSolutionType] = None,
    ...
    def compose_message_thread(
        self,
        *,
        recipients_select_type: typing.Optional[toloka.client.message_thread.RecipientsSelectType] = None,
