...
class RuleCondition(BaseTolokaObject):
    def __init__(self, *, operator: Optional[Any] = None, value: Optional[Any] = None) -> None:
...
class ComparableRuleCondition(RuleCondition, ComparableConditionMixin):
    def __init__(self, operator: CompareOperator, *, value: Optional[Any] = None) -> None:
...
class IdentityRuleCondition(RuleCondition, IdentityConditionMixin):
    def __init__(self, operator: IdentityOperator, *, value: Optional[Any] = None) -> None:
...
class AssessmentEvent(IdentityRuleCondition):
    ...
    def __init__(self, operator: IdentityOperator, value: Optional[Type] = None) -> None:
...
class NextAssignmentAvailable(ComparableRuleCondition):
    def __init__(self, operator: CompareOperator, value: Optional[bool] = None) -> None:
...
class SkillId(IdentityRuleCondition):
    ...
    def __init__(self, operator: IdentityOperator, value: Optional[str] = None) -> None:
