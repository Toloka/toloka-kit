...
import toloka.client.util._codegen
import toloka.client.util._extendable_enum
import typing


class RuleType(toloka.client.util._extendable_enum.ExtendableStrEnum):
    """An enumeration.
    """
...
class RuleAction(toloka.client.util._codegen.BaseParameters):
    """Base class for all actions in quality controls configurations
    """

    def __init__(self, *, parameters: typing.Optional[toloka.client.util._codegen.BaseParameters.Parameters] = None) -> None:
        """Method generated by attrs for class RuleAction.
        """
        ...

    _unexpected: typing.Optional[typing.Dict[str, typing.Any]]
    parameters: typing.Optional[toloka.client.util._codegen.BaseParameters.Parameters]
...
class Restriction(RuleAction):
    ...
    class Parameters(toloka.client.util._codegen.BaseParameters.Parameters):
        def __init__(
            self,
            *,
    ...
    class Parameters(toloka.client.util._codegen.BaseParameters.Parameters):
        def __init__(
            ...
            *,
            ...
            duration_unit: typing.Optional[toloka.client.user_restriction.DurationUnit] = None,
            private_comment: typing.Optional[str] = None
        ) -> None:
    ...
    class Parameters(toloka.client.util._codegen.BaseParameters.Parameters):
        def __init__(
            ...
            *,
            ...
            from_field: typing.Optional[toloka.client.conditions.RuleConditionKey] = None
        ) -> None:
