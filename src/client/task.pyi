...
class BaseTask(BaseTolokaObject):
    ...
    class KnownSolution(BaseTolokaObject):
        ...
        def __init__(self, *, output_values: Optional[Dict[str, Any]] = None, correctness_weight: Optional[float] = None) -> None:
    ...
    def __init__(self, *, input_values: Optional[Dict[str, Any]] = None, known_solutions: Optional[List[KnownSolution]] = None, message_on_unknown_solution: Optional[str] = None, id: Optional[str] = None, origin_task_id: Optional[str] = None) -> None:
...
class Task(InfiniteOverlapParametersMixin, BaseTask):
    ...
    class BaselineSolution(BaseTolokaObject):
        def __init__(self, *, output_values: Optional[Dict[str, Any]] = None, confidence_weight: Optional[float] = None) -> None:
    ...
    def __init__(self, *, input_values: Optional[Dict[str, Any]] = None, known_solutions: Optional[List[BaseTask.KnownSolution]] = None, message_on_unknown_solution: Optional[str] = None, id: Optional[str] = None, infinite_overlap=None, overlap=None, pool_id: Optional[str] = None, remaining_overlap: Optional[int] = None, reserved_for: Optional[List[str]] = None, unavailable_for: Optional[List[str]] = None, traits_all_of: Optional[List[str]] = None, traits_any_of: Optional[List[str]] = None, traits_none_of_any: Optional[List[str]] = None, origin_task_id: Optional[str] = None, created: Optional[datetime] = None, baseline_solutions: Optional[List[BaselineSolution]] = None) -> None:
...
class CreateTaskParameters(Parameters):
    ...
    def __init__(self, *, allow_defaults: Optional[bool] = None, open_pool: Optional[bool] = None) -> None:
...
class CreateTaskAsyncParameters(CreateTaskParameters):
    def __init__(self, *, allow_defaults: Optional[bool] = None, open_pool: Optional[bool] = None, operation_id: Optional[UUID] = None) -> None:
...
class CreateTasksParameters(CreateTaskParameters):
    ...
    def __init__(self, *, allow_defaults: Optional[bool] = None, open_pool: Optional[bool] = None, skip_invalid_items: Optional[bool] = None, operation_id: Optional[UUID] = None, async_mode: Optional[bool] = True) -> None:
...
class TaskOverlapPatch(BaseTolokaObject):
    ...
    def __init__(self, *, overlap: Optional[int] = None, infinite_overlap: Optional[bool] = None) -> None:
...
class TaskPatch(TaskOverlapPatch):
    ...
    def __init__(self, *, overlap: Optional[int] = None, infinite_overlap: Optional[bool] = None, baseline_solutions: Optional[List[Task.BaselineSolution]] = None) -> None:
