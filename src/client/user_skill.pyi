...
class SetUserSkillRequest(BaseTolokaObject):
    ...
    def __init__(self, *, skill_id: Optional[str] = None, user_id: Optional[str] = None, value: Optional[Decimal] = None) -> None:
...
class UserSkill(BaseTolokaObject):
    ...
    def __init__(self, *, id: Optional[str] = None, skill_id: Optional[str] = None, user_id: Optional[str] = None, value: Optional[int] = None, exact_value: Optional[Decimal] = None, created: Optional[datetime] = None, modified: Optional[datetime] = None) -> None:
