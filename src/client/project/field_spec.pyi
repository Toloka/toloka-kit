...
class FieldSpec(BaseTolokaObject):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False) -> None:
...
class BooleanSpec(FieldSpec):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False, allowed_values: Optional[List[bool]] = None) -> None:
...
class StringSpec(FieldSpec):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False, min_length: Optional[int] = None, max_length: Optional[int] = None, allowed_values: Optional[List[str]] = None) -> None:
...
class IntegerSpec(FieldSpec):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False, min_value: Optional[int] = None, max_value: Optional[int] = None, allowed_values: Optional[List[int]] = None) -> None:
...
class FloatSpec(FieldSpec):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False, min_value: Optional[float] = None, max_value: Optional[float] = None) -> None:
...
class CoordinatesSpec(FieldSpec):
    ...
    def __init__(self, *, required: Optional[bool] = True, hidden: Optional[bool] = False, current_location: Optional[bool] = None) -> None:
