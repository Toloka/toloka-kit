...
class TriggerPluginV1(BasePluginV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', action: Optional[BaseComponent] = None, condition: Optional[BaseComponent] = None, fire_immediately: Optional[Union[BaseComponent, bool]] = None, on_change_of: Optional[BaseComponent] = None) -> None:
...
class TolokaPluginV1(BasePluginV1):
    ...
    Attributes:
        ...
        task_width: Width of the block with the task. By default, the task is displayed at full width.
    ...
    class TolokaPluginLayout(BaseTemplate):
        ...
        def __init__(self, *, kind: Optional[Kind] = ..., task_width: Optional[float] = None) -> None:
    ...
    @overload
    def __init__(self, *, version: Optional[str] = '1.0.0', kind: Optional[TolokaPluginLayout.Kind] = None, task_width: Optional[float] = None, notifications: Optional[Union[BaseComponent, List[BaseComponent]]] = None) -> None:
        """Method generated by attrs for class TolokaPluginV1.
        """
        ...

    @overload
    def __init__(self, *, version: Optional[str] = '1.0.0', layout: Optional[Union[BaseComponent, TolokaPluginLayout]] = ..., notifications: Optional[Union[BaseComponent, List[BaseComponent]]] = None) -> None:
        """Method generated by attrs for class TolokaPluginV1.
        """
        ...
