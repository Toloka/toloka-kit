...
class ConcatArraysHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', items: Optional[Union[BaseComponent, List[Any]]] = None) -> None:
...
class Entries2ObjectHelperV1(BaseHelperV1):
    ...
    class Entry(BaseTemplate):
        def __init__(self, *, key: Optional[Union[BaseComponent, str]] = None, value: Optional[Any] = None) -> None:
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', entries: Optional[Union[BaseComponent, List[Union[BaseComponent, Entry]]]] = None) -> None:
...
class IfHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', condition: Optional[BaseComponent] = None, then: Optional[Any] = None, else_: Optional[Any] = None) -> None:
...
class JoinHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', items: Optional[Union[BaseComponent, List[Union[BaseComponent, str]]]] = None, by: Optional[Any] = None) -> None:
...
class Object2EntriesHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', data: Optional[Any] = None) -> None:
...
class ReplaceHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', data: Optional[Any] = None, find: Optional[Union[BaseComponent, str]] = None, replace: Optional[Union[BaseComponent, str]] = None) -> None:
...
class SearchQueryHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', query: Optional[Any] = None, engine: Optional[Union[BaseComponent, Engine]] = None) -> None:
...
class SwitchHelperV1(BaseHelperV1):
    ...
    class Case(BaseTemplate):
        ...
        def __init__(self, *, condition: Optional[BaseComponent] = None, result: Optional[Any] = None) -> None:
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', cases: Optional[Union[BaseComponent, List[Union[BaseComponent, Case]]]] = None, default: Optional[Any] = None) -> None:
...
class TextTransformHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', data: Optional[Any] = None, transformation: Optional[Union[BaseComponent, Transformation]] = None) -> None:
...
class TransformHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', into: Optional[Any] = None, items: Optional[Union[BaseComponent, List[Any]]] = None) -> None:
...
class YandexDiskProxyHelperV1(BaseHelperV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', path: Optional[Union[BaseComponent, str]] = None) -> None:
