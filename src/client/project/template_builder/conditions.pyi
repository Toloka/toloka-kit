...
class BaseConditionV1(VersionedBaseComponent):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None) -> None:
...
class AllConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, conditions: Optional[Union[BaseComponent, List[BaseComponent]]] = None) -> None:
...
class DistanceConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, from_: Optional[Union[BaseComponent, str]] = None, to_: Optional[Union[BaseComponent, str]] = None, max: Optional[Union[BaseComponent, float]] = None) -> None:
    ...
    version: Optional[str]
    hint: Optional[Any]
    from_: Optional[Union[BaseComponent, str]]
...
class EmptyConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, data: Optional[Any] = None) -> None:
...
class EqualsConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, to: Optional[Any] = None, data: Optional[Any] = None) -> None:
...
class LinkOpenedConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, url: Optional[Any] = None) -> None:
...
class NotConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, condition: Optional[BaseComponent] = None) -> None:
...
class SchemaConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, data: Optional[Any] = None, schema: Optional[Dict] = None) -> None:
...
class SubArrayConditionV1(BaseConditionV1):
    ...
    def __init__(self, *, version: Optional[str] = '1.0.0', hint: Optional[Any] = None, data: Optional[Any] = None, parent: Optional[Any] = None) -> None:
