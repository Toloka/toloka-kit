...
class BaseLayoutV1(BaseComponent):
...
class CompareLayoutV1(BaseLayoutV1):
    ...
    * You can add individual selection buttons for every item being compared.
    ...
    validation: Optional[BaseComponent]
    version: Optional[str]
    common_controls: Optional[BaseComponent]
    items: Optional[Union[BaseComponent, List[Union[BaseComponent, CompareLayoutItem]]]]
    min_width: Optional[Union[BaseComponent, float]]
    wide_common_controls: Optional[Union[BaseComponent, bool]]
