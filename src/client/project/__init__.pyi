...
ClassicViewSpec = ClassicViewSpecTemplateBuilderViewSpec = TemplateBuilderViewSpecBooleanSpec = BooleanSpecStringSpec = StringSpecIntegerSpec = IntegerSpecFloatSpec = FloatSpecUrlSpec = UrlSpecFileSpec = FileSpecCoordinatesSpec = CoordinatesSpecJsonSpec = JsonSpecArrayBooleanSpec = ArrayBooleanSpecArrayStringSpec = ArrayStringSpecArrayIntegerSpec = ArrayIntegerSpecArrayFloatSpec = ArrayFloatSpecArrayUrlSpec = ArrayUrlSpecArrayFileSpec = ArrayFileSpecArrayCoordinatesSpec = ArrayCoordinatesSpec