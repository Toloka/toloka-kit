...
class BasePoolObserver(BaseObserver):
    ...
    def __init__(
        self,
        toloka_client: typing.TypeVar('T', bound=None),
        pool_id: str
    ) -> None:
...
class _CursorAndCallbacks:
    def __init__(self, cursor: ...) -> None:
        """Method generated by attrs for class _CursorAndCallbacks.
        """
        ...

    cursor: ...
    callbacks: typing.List[typing.Union[typing.Callable[[typing.List[toloka.streaming.event.AssignmentEvent]], None], typing.Callable[[typing.List[toloka.streaming.event.AssignmentEvent]], typing.Awaitable[None]]]]
...
class AssignmentsObserver(BasePoolObserver):
    ...
    toloka_client: typing.Union[toloka.client.TolokaClient, ...]
    pool_id: str
    _callbacks: typing.Dict[toloka.streaming.event.AssignmentEvent.Type, _CursorAndCallbacks]
