...
class Pipeline:
    ...
    class RunState:
        ...
        def __init__(
            self,
            pipeline_key: str,
            workers: typing.Dict[_Worker, None] = attr._make._Nothing.NOTHING,
            waiting: typing.Dict[_Worker, asyncio.Task] = attr._make._Nothing.NOTHING,
            pending: typing.Dict[_Worker, datetime.datetime] = attr._make._Nothing.NOTHING
        ) -> None:
